...
import { createZGServingNetworkBroker, ServiceModel } from '@0glabs/0g-serving-broker'; // Import the Service type
  ...
  return (
    <>
      <Hero
        ...
        credits={
          <>
            Developed with ❤️ by the Degentic Systems team.{" "}
            <a
              href="https://linkedin.com/in/hanyoon1"
              target="_blank"
              rel="noreferrer"
              className="underline"
            >
